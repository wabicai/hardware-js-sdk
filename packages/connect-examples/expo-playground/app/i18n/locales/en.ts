export const en = {
  translation: {
    ...
    methodDescriptions: {
      ...
      firmwareUpdateV4:
        'Protocol V2 firmware update for bootloader, application P1/P2, coprocessor and SE01-04; resource bundles are written separately and romloader is unsupported',
      ...
      deviceFactoryInfoGet: 'Protocol V2 factory-mode device information query',
      filesystemPermissionFix: 'Protocol V2 filesystem permission repair',
      pathInfo: 'Protocol V2 filesystem path information',
      dirList: 'Protocol V2 filesystem directory listing',
      dirMake: 'Protocol V2 filesystem directory creation',
      dirRemove: 'Protocol V2 filesystem directory removal',
      fileRead: 'Protocol V2 filesystem file chunk read',
      fileWrite: 'Protocol V2 filesystem file chunk write',
      fileDelete: 'Protocol V2 filesystem file deletion',
      filesystemPathInfoQuery: 'Protocol V2 raw FilesystemPathInfoQuery',
      filesystemFileRead: 'Protocol V2 raw FilesystemFileRead',
      filesystemFileWrite: 'Protocol V2 raw FilesystemFileWrite',
      filesystemFileDelete: 'Protocol V2 raw FilesystemFileDelete',
      filesystemDirList: 'Protocol V2 raw FilesystemDirList',
      filesystemDirMake: 'Protocol V2 raw FilesystemDirMake',
      filesystemDirRemove: 'Protocol V2 raw FilesystemDirRemove',
      filesystemFormat: 'Protocol V2 filesystem format',
      filesystemDiskControl: 'Protocol V2 MSC disk control',
      getFeatures: 'Get legacy Features (Protocol V1 compatibility only)',
      getLogs: 'Get device logs',
      getNextU2FCounter: 'Get next U2F counter value',
      getOnekeyFeatures: 'Get legacy OneKey Features (Protocol V1 compatibility only)',
